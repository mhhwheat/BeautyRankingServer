...
/**
 * Servlet implementation class GetMyFollowPhoto
 */
public class GetMyFollowPhoto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetMyFollowPhoto() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PhotoListJson beautyIntroductionListJson=dbHelper.getMyFollowPhoto(Integer.parseInt(firstIndex), Integer.parseInt(count),userPhoneNumber);
